...
inline void Psyc03::init(NervousSuperMother *device){
  ...
  this->device->setHandleMuxControlChange(0, onShapeChange);
  this->device->setHandleMuxControlChange(1, onTuneChange);
  this->device->setHandleMuxControlChange(2, onSweepCHange);
  this->device->setHandleMuxControlChange(3, onFmChange);
  this->device->setHandleMuxControlChange(4, onAttackChange);
  this->device->setHandleMuxControlChange(5, onDecayChange);
  this->device->setHandleMuxControlChange(6, onCutoffChange);
  this->device->setHandleMuxControlChange(7, onSpeedChange);
  this->device->setHandleMuxControlChange(8, onDepth);

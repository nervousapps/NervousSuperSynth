...
inline void Synth::init(NervousSuperMother *device){
  ...
  // Device callbacks
  this->device->setHandleMuxControlChange(0, onModeChange);
  this->device->setHandleMuxControlChange(1, onParamChange);
  this->device->setHandleMuxControlChange(2, onShapeChange);
  this->device->setHandleMuxControlChange(3, onFmChange);
  this->device->setHandleMuxControlChange(4, onAttackChange);
  this->device->setHandleMuxControlChange(5, onReleaseChange);

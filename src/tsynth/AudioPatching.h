...
AudioSynthWaveformDcPrivate     constant1Dc;    //xy=69.5,437
AudioSynthNoisePink      pink;           //xy=268,349
AudioSynthNoiseWhite     white;           //xy=268,359
AudioMixer4Private              noiseMixer;       //xy=288,369
AudioSynthWaveformTS       pwmLfo;         //xy=92,208
AudioSynthWaveformDcPrivate     pwa;            //xy=107,256
AudioSynthWaveformDcPrivate     pwb;            //xy=110,301
AudioEffectEnvelopePrivate      filterEnvelope6;   //xy=629,1107
AudioEffectEnvelopePrivate      filterEnvelope5;   //xy=638,300
AudioEffectEnvelopePrivate      filterEnvelope4;   //xy=617,1107
AudioEffectEnvelopePrivate      filterEnvelope1;   //xy=628,300
AudioEffectEnvelopePrivate      filterEnvelope3;   //xy=636,857
AudioEffectEnvelopePrivate      filterEnvelope2;   //xy=640,604
AudioMixer4Private              pwMixer1a;       //xy=281,169
AudioMixer4Private              pwMixer1b;       //xy=287,272
AudioMixer4Private              pwMixer4b;         //xy=313.75,954.75
AudioMixer4Private              pwMixer4a;         //xy=314.75,887.75
AudioMixer4Private              pwMixer2a;         //xy=323.75,472.75
AudioMixer4Private              pwMixer2b;         //xy=323.75,553.75
AudioMixer4Private              pwMixer3a;         //xy=353.75,688.75
AudioMixer4Private              pwMixer3b;         //xy=358.75,763.75
AudioMixer4Private              pwMixer5a;         //xy=323.75,472.75
AudioMixer4Private              pwMixer5b;         //xy=323.75,553.75
AudioMixer4Private              pwMixer6a;         //xy=353.75,688.75
AudioMixer4Private              pwMixer6b;         //xy=358.75,763.75
AudioSynthWaveformTS       pitchLfo;         //xy=122,111
AudioSynthWaveformDcPrivate     glide1;          //xy=124,152
AudioSynthWaveformDcPrivate     glide2;          //xy=124,152
AudioSynthWaveformDcPrivate     glide3;          //xy=124,152
AudioSynthWaveformDcPrivate     glide4;          //xy=124,152
AudioSynthWaveformDcPrivate     glide5;          //xy=124,152
AudioSynthWaveformDcPrivate     glide6;          //xy=124,152
AudioSynthWaveformDcPrivate     pitchBend;      //xy=128,74
AudioSynthWaveformTS       filterLfo;         //xy=166,632
AudioSynthWaveformDcPrivate     keytracking1;    //xy=176,745
AudioSynthWaveformDcPrivate     keytracking2;    //xy=196,745
AudioSynthWaveformDcPrivate     keytracking3;    //xy=216,745
AudioSynthWaveformDcPrivate     keytracking4;    //xy=236,745
AudioSynthWaveformDcPrivate     keytracking5;    //xy=216,745
AudioSynthWaveformDcPrivate     keytracking6;    //xy=236,745
AudioMixer4Private              oscGlobalModMixer;    //xy=296,95
AudioMixer4Private              oscModMixer1a;         //xy=550,165
AudioMixer4Private              oscModMixer1b;         //xy=550,195
AudioMixer4Private              oscModMixer2a;         //xy=550,205
AudioMixer4Private              oscModMixer2b;         //xy=550,225
AudioMixer4Private              oscModMixer3a;         //xy=550,245
AudioMixer4Private              oscModMixer3b;         //xy=550,265
AudioMixer4Private              oscModMixer4a;         //xy=550,285
AudioMixer4Private              oscModMixer4b;         //xy=550,305
AudioMixer4Private              oscModMixer5a;         //xy=550,245
AudioMixer4Private              oscModMixer5b;         //xy=550,265
AudioMixer4Private              oscModMixer6a;         //xy=550,285
AudioMixer4Private              oscModMixer6b;         //xy=550,305
...
AudioEffectDigitalCombinePrivate oscFX1;       //xy=663,223
AudioEffectDigitalCombinePrivate oscFX2;       //xy=684,542
AudioEffectDigitalCombinePrivate oscFX4;       //xy=686,1046
AudioEffectDigitalCombinePrivate oscFX3;       //xy=687,803
AudioEffectDigitalCombinePrivate oscFX5;       //xy=686,1046
AudioEffectDigitalCombinePrivate oscFX6;       //xy=687,803
AudioMixer4Private              waveformMixer1; //xy=824,170
AudioMixer4Private              waveformMixer2; //xy=829,476
AudioMixer4Private              waveformMixer3; //xy=846,774
AudioMixer4Private              waveformMixer4; //xy=854,1023
AudioMixer4Private              waveformMixer5; //xy=846,774
AudioMixer4Private              waveformMixer6; //xy=854,1023
AudioMixer4Private              filterModMixer1;   //xy=845,292
AudioMixer4Private              filterModMixer2;   //xy=848,637
AudioMixer4Private              filterModMixer3;   //xy=852,937
AudioMixer4Private              filterModMixer4;   //xy=855,1099
AudioMixer4Private              filterModMixer5;   //xy=852,937
AudioMixer4Private              filterModMixer6;   //xy=855,1099
AudioFilterStateVariablePrivate filter2;        //xy=994,498
AudioFilterStateVariablePrivate filter1;        //xy=1000,210
AudioFilterStateVariablePrivate filter3;        //xy=1002,822
AudioFilterStateVariablePrivate filter4;        //xy=1022,1047
AudioFilterStateVariablePrivate filter5;        //xy=1002,822
AudioFilterStateVariablePrivate filter6;        //xy=1022,1047
AudioMixer4Private              filterMixer2;   //xy=1144,504
AudioMixer4Private              filterMixer3;   //xy=1144,825
AudioMixer4Private              filterMixer1;   //xy=1151,214
AudioMixer4Private              filterMixer4;   //xy=1155,1050
AudioMixer4Private              filterMixer5;   //xy=1151,214
AudioMixer4Private              filterMixer6;   //xy=1155,1050
AudioEffectEnvelopePrivate      ampEnvelope2;   //xy=1315,503
AudioEffectEnvelopePrivate      ampEnvelope3;   //xy=1315,823
AudioEffectEnvelopePrivate      ampEnvelope4;   //xy=1321,1045
AudioEffectEnvelopePrivate      ampEnvelope1;   //xy=1327,211
AudioEffectEnvelopePrivate      ampEnvelope5;   //xy=1321,1045
AudioEffectEnvelopePrivate      ampEnvelope6;   //xy=1327,211
AudioMixer4Private              voiceMixer1;     //xy=1524,570
AudioMixer4Private              voiceMixer2;     //xy=1524,570
AudioMixer4Private              voiceMixerM;     //xy=1544,580
AudioFilterStateVariablePrivate dcOffsetFilter;     //xy=1564,580
AudioEffectEnsemble       ensemble;  //xy=1800,600
AudioMixer4Private              effectMixerR;         //xy=1848,625
AudioMixer4Private              effectMixerL;         //xy=1857,539

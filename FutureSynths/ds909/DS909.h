...
inline void DS909::init(NervousSuperMother *device){
  ...
  // Device callbacks
  this->device->setHandleMuxControlChange(0, onBDChange);
  this->device->setHandleMuxControlChange(1, onSNChange);
  this->device->setHandleMuxControlChange(2, onCPChange);
  this->device->setHandleMuxControlChange(3, onLTChange);
  this->device->setHandleMuxControlChange(4, onMTChange);
  this->device->setHandleMuxControlChange(5, onHTChange);
  this->device->setHandleMuxControlChange(6, onRMChange);
  this->device->setHandleMuxControlChange(7, onHHChange);
  this->device->setHandleMuxControlChange(8, onCYChange);
